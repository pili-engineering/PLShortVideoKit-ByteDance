...
@property (nonatomic, strong) PLSEffectModel *filter;
...
- (void)configureWithFilter:(PLSEffectModel *)filter {
    _filter = filter;
    
    _titleLabel.text = filter.displayName;
    _imageView.image = filter.iconImage;
}
